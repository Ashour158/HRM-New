...
@Injectable()
export class Feedback360ResponseRepository extends BaseRepository<any, Feedback360Response> {
  protected readonly tableName = 'performance_feedback_360_responses' as any;
  ...
  private toAggregate(row: any): Feedback360Response {
