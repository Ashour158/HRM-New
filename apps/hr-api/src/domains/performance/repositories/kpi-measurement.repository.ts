...
@Injectable()
export class KpiMeasurementRepository extends BaseRepository<any, KpiMeasurement> {
  protected readonly tableName = 'kpi_measurements' as any;
  ...
  private toAggregate(row: any): KpiMeasurement {
