...
@Injectable()
export class DevelopmentPlanRepository extends BaseRepository<any, DevelopmentPlan> {
  protected readonly tableName = 'development_plans' as any;
  ...
  private toAggregate(row: any): DevelopmentPlan {
