...
@CommandHandler('EnterCalibrationPerformanceReviewCycle')
@Injectable()
export class EnterCalibrationPerformanceReviewCycleHandler {
  constructor(
  ...
  async handle(command: HrCommandEnvelope<unknown>): Promise<CommandResult<unknown>> {
    ...
    ar.enterCalibration(command.correlationId);
