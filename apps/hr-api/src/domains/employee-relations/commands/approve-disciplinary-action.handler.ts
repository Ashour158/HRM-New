...
@CommandHandler('ApproveDisciplinaryAction')
@Injectable()
export class ApproveDisciplinaryActionHandler {
  constructor(
  ...
  async handle(command: HrCommandEnvelope<unknown>): Promise<CommandResult<unknown>> {
    const payload = command.payload as { disciplinaryActionId: Uuid; approvedBy: Uuid };
