...
export interface ApprovePolicyDocumentPayload {
  documentId: string;
}

/**
 * Handler for the ApprovePolicyDocument command.
 */
@Injectable()
@CommandHandler('ApprovePolicyDocument')
export class ApprovePolicyDocumentHandler implements ICommandHandler {
  readonly commandName = 'ApprovePolicyDocument';
  ...
  async handle(command: HrCommandEnvelope<unknown>): Promise<CommandResult<unknown>> {
    ...
    return {
      ...
      allowedNextActions: ['PublishPolicyDocument'],
