...
export interface ArchivePolicyDocumentPayload {
  documentId: string;
}

/**
 * Handler for the ArchivePolicyDocument command.
 */
@Injectable()
@CommandHandler('ArchivePolicyDocument')
export class ArchivePolicyDocumentHandler implements ICommandHandler {
  readonly commandName = 'ArchivePolicyDocument';
