...
/**
 * Command handler for generating a TotalCompensationStatement.
 */
@Injectable()
@CommandHandler('GenerateTotalCompensationStatement')
export class GenerateTotalCompensationStatementHandler implements ICommandHandler {
  commandName = 'GenerateTotalCompensationStatement' as const;
  ...
  async handle(command: HrCommandEnvelope<unknown>): Promise<CommandResult<unknown>> {
    ...
    statement.generate(command.correlationId);
