...
/**
 * Command handler for creating a new PayScale.
 */
@Injectable()
@CommandHandler('CreatePayScale')
export class CreatePayScaleHandler implements ICommandHandler {
  commandName = 'CreatePayScale' as const;
