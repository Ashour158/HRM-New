...
/**
 * Command handler for recording vested units on an EquityGrant.
 */
@Injectable()
@CommandHandler('RecordVestingEquityGrant')
export class RecordVestingEquityGrantHandler implements ICommandHandler {
  commandName = 'RecordVestingEquityGrant' as const;
