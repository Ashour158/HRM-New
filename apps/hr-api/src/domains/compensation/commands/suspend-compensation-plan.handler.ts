...
/**
 * Command handler for suspending a CompensationPlan.
 */
@Injectable()
@CommandHandler('SuspendCompensationPlan')
export class SuspendCompensationPlanHandler implements ICommandHandler {
  commandName = 'SuspendCompensationPlan' as const;
  ...
  async handle(command: HrCommandEnvelope<unknown>): Promise<CommandResult<unknown>> {
    ...
    plan.suspend(command.correlationId);
