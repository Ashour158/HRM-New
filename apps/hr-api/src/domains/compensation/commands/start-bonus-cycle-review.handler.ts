...
/**
 * Command handler for moving a BonusCycle into payout review.
 * CALCULATION → REVIEW.
 */
@Injectable()
@CommandHandler('StartBonusCycleReview')
export class StartBonusCycleReviewHandler implements ICommandHandler {
  commandName = 'StartBonusCycleReview' as const;
  ...
  async handle(command: HrCommandEnvelope<unknown>): Promise<CommandResult<unknown>> {
    ...
    cycle.startReview(command.correlationId);
