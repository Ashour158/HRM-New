...
/**
 * Command handler for creating a new EquityGrant.
 */
@Injectable()
@CommandHandler('CreateEquityGrant')
export class CreateEquityGrantHandler implements ICommandHandler {
  commandName = 'CreateEquityGrant' as const;
