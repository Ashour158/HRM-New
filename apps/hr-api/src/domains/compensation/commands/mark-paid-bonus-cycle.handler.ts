...
/**
 * Command handler for marking a BonusCycle as paid.
 */
@Injectable()
@CommandHandler('MarkPaidBonusCycle')
export class MarkPaidBonusCycleHandler implements ICommandHandler {
  commandName = 'MarkPaidBonusCycle' as const;
