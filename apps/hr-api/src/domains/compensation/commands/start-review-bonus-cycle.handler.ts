...
/**
 * Command handler for starting review of a BonusCycle.
 */
@Injectable()
@CommandHandler('StartReviewBonusCycle')
export class StartReviewBonusCycleHandler implements ICommandHandler {
  commandName = 'StartReviewBonusCycle' as const;
