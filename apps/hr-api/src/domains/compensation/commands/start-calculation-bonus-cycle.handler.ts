...
/**
 * Command handler for starting bonus calculation for a BonusCycle.
 */
@Injectable()
@CommandHandler('StartCalculationBonusCycle')
export class StartCalculationBonusCycleHandler implements ICommandHandler {
  commandName = 'StartCalculationBonusCycle' as const;
