...
/**
 * Command handler for activating a CompensationBand.
 * DRAFT → ACTIVE.
 */
@Injectable()
@CommandHandler('ActivateCompensationBand')
export class ActivateCompensationBandHandler implements ICommandHandler {
  commandName = 'ActivateCompensationBand' as const;
  ...
  async handle(command: HrCommandEnvelope<unknown>): Promise<CommandResult<unknown>> {
    ...
    band.activate(command.correlationId);
