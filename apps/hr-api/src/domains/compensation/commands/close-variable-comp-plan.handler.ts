...
/**
 * Command handler for closing a VariableCompPlan.
 * ACTIVE → CLOSED (terminal).
 */
@Injectable()
@CommandHandler('CloseVariableCompPlan')
export class CloseVariableCompPlanHandler implements ICommandHandler {
  commandName = 'CloseVariableCompPlan' as const;
