...
/**
 * Command handler for activating a CompensationPlan.
 */
@Injectable()
@CommandHandler('ActivateCompensationPlan')
export class ActivateCompensationPlanHandler implements ICommandHandler {
  commandName = 'ActivateCompensationPlan' as const;
