...
/**
 * Command handler for starting vesting of an EquityGrant.
 */
@Injectable()
@CommandHandler('StartVestingEquityGrant')
export class StartVestingEquityGrantHandler implements ICommandHandler {
  commandName = 'StartVestingEquityGrant' as const;
