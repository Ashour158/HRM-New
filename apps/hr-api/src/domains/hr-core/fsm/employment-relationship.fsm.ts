...
export function registerEmploymentRelationshipFsm(fsm: FsmFramework): void {
  const definition: FsmDefinition<string, string> = {
    ...
    transitions: [
      ...
      { action: 'StartProbationEmploymentRelationship', from: 'ACTIVE', to: 'PROBATION', eventName: 'ProbationStarted' },
      { action: 'CompleteProbationEmploymentRelationship', from: 'PROBATION', to: 'CONFIRMED', eventName: 'EmploymentConfirmed' },
