...
interface RehireWorkerPayload {
  workerId: Uuid | string;
}

@CommandHandler('RehireWorker')
@Injectable()
export class RehireWorkerHandler {
  constructor(
