  ...
  private packHighlights(packCode: string): ReportAnalyticsRunResult['highlights'] {
    if (packCode === 'FULL_HR_ANALYTICS') {
      return [
        ...
        { label: 'Payroll net pay', value: '210,000', tone: 'default' },
        { label: 'Pending actions', value: 11, tone: 'warning' },
      ];
    }
    if (packCode === 'REWARD_CONTROL') {
      return [
        { label: 'Net pay', value: '210,000', tone: 'default' },
    ...
    insights: [
      {
        ...
        affectedRecords: [{ label: 'Engineering', value: '42,000 liability', severity: 'risk' }],
  ...
  },
  {
    ...
    insights: [
      ...
      },
      {
        ...
        affectedRecords: [{ label: 'Engineering', value: '4,200 attendance deductions', severity: 'watch' }],
