...
@CommandHandler('ApproveShiftSwapRequest')
@Injectable()
export class ApproveShiftSwapRequestHandler {
  constructor(
  ...
  async handle(command: HrCommandEnvelope<unknown>): Promise<CommandResult<unknown>> {
    const payload = command.payload as { shiftSwapRequestId: Uuid; approvedBy: Uuid };
