 ...
 *
 * Transitions a requisition from DRAFT to PENDING_APPROVAL. Without this
 * handler, ApproveJobRequisition (which requires PENDING_APPROVAL) could
 * never succeed -- a requisition created via CreateJobRequisition had no
 * way to leave DRAFT (HCM-P0-7).
 */
@Injectable()
