...
@CommandHandler('ApproveRecognitionRecord')
@Injectable()
export class ApproveRecognitionRecordHandler {
  constructor(
  ...
  async handle(command: HrCommandEnvelope<unknown>): Promise<CommandResult<unknown>> {
    const payload = command.payload as { recognitionRecordId: Uuid; approvedBy: Uuid };
