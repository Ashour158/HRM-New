...
@Injectable()
export class RecognitionRecordRepository extends BaseRepository<any, RecognitionRecord> {
  protected readonly tableName = 'recognition_records' as any;
  ...
  private toAggregate(row: any): RecognitionRecord {
