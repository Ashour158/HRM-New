...
@Injectable()
export class EngagementSurveyRepository extends BaseRepository<any, EngagementSurvey> {
  protected readonly tableName = 'engagement_surveys' as any;
  ...
  private toAggregate(row: any): EngagementSurvey {
