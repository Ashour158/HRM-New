...
export interface SuspendHrAiUseCasePayload {
  hrAiUseCaseId: string;
}

@Injectable()
@CommandHandler('SuspendHrAiUseCase')
export class SuspendHrAiUseCaseHandler {
  constructor(
