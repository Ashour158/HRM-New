...
@Injectable()
export class CertificationRepository extends BaseRepository<any, Certification> {
  protected readonly tableName = 'certifications' as any;
  ...
  private toAggregate(row: any): Certification {
