...
export interface QuarantineCountryPolicyPackPayload {
  packId: string;
}

/**
 * Handler for the QuarantineCountryPolicyPack command.
 */
@Injectable()
@CommandHandler('QuarantineCountryPolicyPack')
export class QuarantineCountryPolicyPackHandler implements ICommandHandler {
  readonly commandName = 'QuarantineCountryPolicyPack';
