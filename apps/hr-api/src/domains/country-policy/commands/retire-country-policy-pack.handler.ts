...
export interface RetireCountryPolicyPackPayload {
  packId: string;
}

/**
 * Handler for the RetireCountryPolicyPack command.
 */
@Injectable()
@CommandHandler('RetireCountryPolicyPack')
export class RetireCountryPolicyPackHandler implements ICommandHandler {
  readonly commandName = 'RetireCountryPolicyPack';
