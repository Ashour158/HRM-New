...
export interface ParseCountryPolicyPackPayload {
  packId: string;
}

/**
 * Handler for the ParseCountryPolicyPack command.
 */
@Injectable()
@CommandHandler('ParseCountryPolicyPack')
export class ParseCountryPolicyPackHandler implements ICommandHandler {
  readonly commandName = 'ParseCountryPolicyPack';
  ...
  async handle(command: HrCommandEnvelope<unknown>): Promise<CommandResult<unknown>> {
    ...
    return {
      ...
      allowedNextActions: ['ValidateCountryPolicyPack'],
