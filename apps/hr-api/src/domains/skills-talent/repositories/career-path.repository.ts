...
@Injectable()
export class CareerPathRepository extends BaseRepository<any, CareerPath> {
  protected readonly tableName = 'career_paths' as any;
  ...
  private toAggregate(row: any): CareerPath {
