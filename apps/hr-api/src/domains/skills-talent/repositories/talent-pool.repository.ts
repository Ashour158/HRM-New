...
@Injectable()
export class TalentPoolRepository extends BaseRepository<any, TalentPool> {
  protected readonly tableName = 'talent_pools' as any;
  ...
  private toAggregate(row: any): TalentPool {
