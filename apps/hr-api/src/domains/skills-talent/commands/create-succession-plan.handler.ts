...
import { SuccessionPlan } from '../aggregates/succession-plan.aggregate.js';
...
@CommandHandler('CreateSuccessionPlan')
@Injectable()
export class CreateSuccessionPlanHandler {
  constructor(
  ...
  async handle(command: HrCommandEnvelope<unknown>): Promise<CommandResult<unknown>> {
    ...
    const ar = SuccessionPlan.create(
      {
        id: Uuid.generate(),
        tenantId: command.tenantId,
        positionId: payload.positionId,
        incumbentWorkerId: payload.incumbentWorkerId,
        successorCandidates: payload.successorCandidates,
      },
