...
const REPORT_BUILDER_CATALOG = {
  ...
  businessRelationships: [
    { code: 'headcount-attendance-capacity', title: 'Headcount to Attendance Capacity', from: 'HEADCOUNT', to: 'ATTENDANCE', relationship: 'Capacity and exception context', businessUse: 'Shows whether attendance exceptions are isolated issues or symptoms of vacancy and coverage pressure.' },
    { code: 'leave-payroll-liability', title: 'Leave Liability to Payroll', from: 'LEAVE', to: 'PAYROLL', relationship: 'Absence cost and payroll readiness', businessUse: 'Connects approved leave and balances to payroll cost, deductions, and period close evidence.' },
    ...
    { code: 'benefits-payroll-cost', title: 'Benefits to Payroll Cost', from: 'BENEFITS', to: 'PAYROLL', relationship: 'Contribution and deduction validation', businessUse: 'Compares enrollment and contribution data with payroll deduction results.' },
    { code: 'compliance-services-control', title: 'Compliance to HR Services Control', from: 'COMPLIANCE', to: 'SERVICES', relationship: 'Policy follow-up and service demand', businessUse: 'Links overdue acknowledgements and policy gaps to cases, tasks, and SLA-sensitive HR service work.' },
    { code: 'performance-headcount-talent', title: 'Performance to Workforce Planning', from: 'PERFORMANCE', to: 'HEADCOUNT', relationship: 'Talent readiness and succession context', businessUse: 'Combines review, rating, and goal signals with position and manager-team structure.' },
  ],
};
