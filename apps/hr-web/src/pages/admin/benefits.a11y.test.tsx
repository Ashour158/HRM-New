...
vi.mock('@/hooks/use-auth', () => ({
  useAuth: () => ({
    user: { id: '00000000-0000-4000-8000-000000000099', roles: [{ id: 'role-1', name: 'BENEFITS_ADMIN' }] },
  }),
}));
...
describe('AdminBenefits accessibility', () => {
  beforeEach(() => {
  ...
  it('renders without accessibility violations', async () => {
    ...
    expect(await screen.findByRole('heading', { name: 'Benefits Administration' })).toBeInTheDocument();
