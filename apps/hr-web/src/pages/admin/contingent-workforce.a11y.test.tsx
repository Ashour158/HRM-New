...
describe('AdminContingentWorkforce accessibility', () => {
  beforeEach(() => {
  ...
  it('renders without accessibility violations', async () => {
    ...
    const { container } = render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <AdminContingentWorkforce />
        </MemoryRouter>
      </QueryClientProvider>,
    );

    expect(await screen.findByRole('heading', { name: 'Contingent Workforce' })).toBeInTheDocument();
