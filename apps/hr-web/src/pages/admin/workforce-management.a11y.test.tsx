...
describe('AdminWorkforceManagement accessibility', () => {
  beforeEach(() => {
  ...
  it('renders without accessibility violations', async () => {
    ...
    await waitFor(() => expect(apiClientGetMock).toHaveBeenCalledWith('/workforce-management/shift-schedules/tenant/00000000-0000-4000-8000-000000000001'));
