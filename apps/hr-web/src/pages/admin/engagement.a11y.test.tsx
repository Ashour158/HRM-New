...
import { AdminEngagement } from './engagement';
...
vi.mock('@/hooks/use-auth', () => ({
  useAuth: () => ({
    user: { id: '00000000-0000-4000-8000-000000000099', roles: [{ id: 'role-1', name: 'ENGAGEMENT_ADMIN' }] },
  }),
}));
...
describe('AdminEngagement accessibility', () => {
  beforeEach(() => {
  ...
  it('renders without accessibility violations', async () => {
    ...
    expect(await screen.findByRole('heading', { name: 'Engagement & Surveys' })).toBeInTheDocument();
