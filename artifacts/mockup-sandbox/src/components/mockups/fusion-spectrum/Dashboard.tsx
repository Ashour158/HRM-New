...
const moduleIcon: Record<string, string> = {
  ...
  violet: "bg-amber-100 text-amber-600",
  purple: "bg-violet-100 text-violet-600",
  fuchsia: "bg-rose-100 text-rose-600",
  rose: "bg-fuchsia-100 text-fuchsia-600",
};
      ...
      <div className="flex items-center gap-3">
        {!isActive ? (
          <button
            ...
            className="flex items-center gap-2 px-7 py-3.5 rounded-2xl font-bold text-white bg-gradient-to-r from-sky-500 to-cyan-600 shadow-lg shadow-sky-500/25 hover:shadow-xl hover:shadow-sky-500/30 transition-all active:scale-95"
          >
    ...
    <div className="min-h-screen fusion-bg text-slate-900 font-['Plus_Jakarta_Sans',sans-serif] flex relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0" aria-hidden="true">
        <div
          ...
          style={{ width: 420, height: 420, top: -80, left: "30%", background: "radial-gradient(circle, #7dd3fc, #0ea5e9)" }}
        />
        <div
          className="fusion-blob fusion-blob-2"
          style={{ width: 360, height: 360, top: "20%", right: "-60px", background: "radial-gradient(circle, #fcd34d, #f59e0b)" }}
        />
        <div
          className="fusion-blob fusion-blob-3"
          style={{ width: 380, height: 380, bottom: "-100px", left: "20%", background: "radial-gradient(circle, #fda4af, #34d399)" }}
        />
      </div>
      ...
      <aside className="w-64 fusion-glass border-r border-white/40 flex-col z-10 hidden lg:flex relative">
            ...
            <nav className="space-y-1">
              {[
                ...
                >
                  <item.icon
                    size={18}
                    className={`mr-3 ${item.active ? "text-sky-600" : "text-slate-400"}`}
                  />
                  {item.label}
                </a>
              ))}
        ...
        <div className="p-4 border-t border-white/30">
          <div className="flex items-center px-2">
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-sky-400 to-violet-400 flex items-center justify-center text-white font-bold text-sm border-2 border-white shadow-sm">
              JD
            </div>
        ...
        <header className="h-16 fusion-glass border-b border-white/30 flex items-center justify-between px-6 lg:px-8 z-20">
          ...
          <div className="hidden lg:flex items-center max-w-md w-full relative">
            ...
            <input
              ...
              className="w-full bg-white/55 border border-white/60 focus:bg-white/80 focus:ring-2 focus:ring-sky-500/20 focus:outline-none rounded-full pl-10 pr-4 py-2 text-sm placeholder:text-slate-400 transition-all shadow-inner"
            />
          </div>
          <div className="flex items-center space-x-3">
            ...
            >
              <img
                ...
                className="w-10 h-10 rounded-full object-cover ring-2 ring-white/70 shadow-md group-hover:ring-sky-400 group-hover:scale-105 transition-all"
              />
        ...
        <div className="flex-1 p-6 lg:p-8">
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
              {/* KPI 1 */}
              <div className="bg-gradient-to-br from-sky-500 to-cyan-600 text-white rounded-[2rem] p-6 fusion-hover flex flex-col justify-between h-[180px] shadow-lg shadow-sky-500/20 relative overflow-hidden group">
              ...
              {/* KPI 2 */}
              <div className="bg-gradient-to-br from-emerald-500 to-teal-600 text-white rounded-[2rem] p-6 fusion-hover flex flex-col justify-between h-[180px] shadow-lg shadow-emerald-500/20 relative overflow-hidden group">
                <div className="absolute -right-6 -top-6 w-32 h-32 bg-white/15 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500" />
                <div className="flex justify-between items-start relative z-10">
                  <div className="p-3 bg-white/20 rounded-2xl backdrop-blur-sm">
                    <TrendingDown size={24} />
                  </div>
                  <div className="px-2.5 py-1 bg-emerald-900/25 rounded-full text-xs font-bold backdrop-blur-sm">
                    -1.2%
                  </div>
                </div>
                <div className="relative z-10">
              ...
              {/* KPI 3 */}
              <div className="bg-gradient-to-br from-amber-500 to-orange-600 text-white rounded-[2rem] p-6 fusion-hover flex flex-col justify-between h-[180px] shadow-lg shadow-amber-500/20 relative overflow-hidden group">
                <div className="absolute -right-6 -top-6 w-32 h-32 bg-white/15 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500" />
                <div className="flex justify-between items-start relative z-10">
                  <div className="p-3 bg-white/20 rounded-2xl backdrop-blur-sm">
                    <Briefcase size={24} />
              ...
              {/* KPI 4 */}
              <div className="bg-gradient-to-br from-violet-500 to-fuchsia-600 text-white rounded-[2rem] p-6 fusion-hover flex flex-col justify-between h-[180px] shadow-lg shadow-violet-500/20 relative overflow-hidden group">
                <div className="absolute -right-6 -top-6 w-32 h-32 bg-white/15 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500" />
                <div className="flex justify-between items-start relative z-10">
                  <div className="p-3 bg-white/20 rounded-2xl backdrop-blur-sm">
                    <UserPlus size={24} />
              ...
              <div className="lg:col-span-3 fusion-glass rounded-[2rem] p-6 lg:p-8 flex flex-col">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-4 text-xs font-semibold text-slate-500">
                    <span className="flex items-center gap-1.5">
                      <span className="w-3 h-3 rounded-full bg-sky-500" /> Hires
                    </span>
                    <span className="flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-6 flex flex-col">
                ...
                <div className="fusion-glass rounded-[2rem] p-6 flex flex-col relative overflow-hidden flex-1">
                  <div className="absolute top-0 right-0 w-64 h-64 bg-sky-400/15 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
