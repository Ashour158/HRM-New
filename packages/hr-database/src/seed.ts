    ...
    WITH demo_users(id, email, first_name, last_name, password_hash, status, roles, permissions) AS (
      VALUES
        ...
        (
          ...
          'ACTIVE',
          '["MANAGER"]'::jsonb,
          '["SAVED_VIEW_READ","SAVED_VIEW_CREATE","SAVED_VIEW_UPDATE","SAVED_VIEW_DELETE","WORKER_READ","WORKER_UPDATE","PERFORMANCE_READ","PERFORMANCE_WRITE","TIME_ATTENDANCE_MANAGE","APPROVAL_MANAGE","WORKFLOW_APPROVE","INTELLIGENCE_READ"]'::jsonb
        ),
        (
          ...
          'ACTIVE',
          '["EMPLOYEE"]'::jsonb,
          '["SAVED_VIEW_READ","SAVED_VIEW_CREATE","SAVED_VIEW_UPDATE","SAVED_VIEW_DELETE","SELF_READ","SELF_UPDATE","TIME_ATTENDANCE_READ","TIME_ATTENDANCE_WRITE","BENEFITS_READ","PAYSLIP_READ"]'::jsonb
        )
    ),
    updated AS (
