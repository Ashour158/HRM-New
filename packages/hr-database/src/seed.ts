    ...
    WITH demo_users(id, email, first_name, last_name, password_hash, status, roles, permissions) AS (
      VALUES
        ...
        (
          ...
          'ACTIVE',
          '["MANAGER"]'::jsonb,
          '["WORKER_READ","WORKER_UPDATE","PERFORMANCE_READ","PERFORMANCE_WRITE","TIME_ATTENDANCE_MANAGE","APPROVAL_MANAGE","WORKFLOW_APPROVE","INTELLIGENCE_READ"]'::jsonb
        ),
        (
